(function () {
    ...
    function config($routeProvider, $locationProvider) {
        ...
        $routeProvider
            ...
            .when('/decoupage/paintings', {
                templateUrl: '../views/partials/decoupage/decoupagePaintings.html',
                controller: 'PaintingsController',
                controllerAs: CONTROLLER_AS_VIEW_MODEL
            })
            .when('/decoupage/paintings/animals', {
                templateUrl: '../../views/partials/decoupage/canvasAnimals.html',
                controller: 'CanvasAnimalsController',
                controllerAs: CONTROLLER_AS_VIEW_MODEL
            })
            .when('/weddings', {
    ...
    function runFunction($rootScope, $location, $window, $sce) {
        ...
        $rootScope.texts = {
            ...
            paintingsHeading: "Декупаж върху платно",
        ...
        $rootScope.paintingsSlider = {
            imageUrl: '../../images/s_platna_1.jpg',
            heading: $rootScope.texts.paintingsHeading,
            subheading: $sce.trustAsHtml($rootScope.texts.madeWithLove),
            initialize: true
        };
